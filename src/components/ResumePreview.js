    ...
    >
      <div ref={printElem}>
        <HStack>
          ...
          <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
            <Heading as="h4" size="md">
              {about.name ? about.name : "ARPIT YADAV"}
            </Heading>
            <Text color={"gray.500"}>
        ...
        >
          <HStack spacing={1}>
            <MdMail />{" "}
            <Text>{about.email ? about.email : "XYZ@gmail.com"}</Text>
          </HStack>
          <HStack spacing={1}>
            <MdLocalPhone />{" "}
            <Text>{about.phone ? about.phone : "+91XXXXXXXXXX"}</Text>
          </HStack>
          <HStack spacing={1}>
            <MdLocationPin />{" "}
              ...
              {educationList.map((education, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text fontSize={"sm"}>
                      {school ? school : "College of XYZ City"}
                    </Text>
                    <HStack
                      fontSize={"xs"}
                      fontStyle={"italic"}
                    ...
                    >
                      ...
                      <Text>{grade ? grade : "X.X CGPA"}</Text>
                    </HStack>
                  </VStack>
                );
              })}
                ...
                return (
                  ...
                  >
                    ...
                    <Text fontSize={"xs"} fontStyle={"italic"}>
                      {startDate ? startDate : "XXXX-XX"} -{" "}
                      {endDate ? endDate : "XXXX-XX"}
                    </Text>
